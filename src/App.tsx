            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#" className="text-white/70 hover:text-[#FFD700] transition-colors text-sm">Gameplay</a></li>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#" className="text-white/70 hover:text-[#FFD700] transition-colors text-sm">Leaderboards</a></li>
                  <li><a href="#" className="text-white/70 hover:text-[#FFD700] transition-colors text-sm">Events</a></li>
